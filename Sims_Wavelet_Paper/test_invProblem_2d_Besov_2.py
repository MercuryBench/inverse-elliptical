...
m1 = Besov11Wavelet(rect, kappa, 0.5, 6)
...
plt.figure();
plt.subplot(211)
plt.plot(unpackWavelet(uOpt.waveletcoeffs)[0:1024], label="uOpt")
plt.legend()
plt.subplot(212)
plt.plot(unpackWavelet(uTruth.waveletcoeffs)[0:1024], label="uTruth")
plt.legend()
