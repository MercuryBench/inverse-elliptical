...
for kappa in kappavals:
	m1 = GeneralizedGaussianWavelet2d(rect, kappa, 1.0, 6)
	...
	result = gradDesc(x0, I_fnc, Phi_fnc, DPhi_fnc, DNormpart_fnc, alpha0=alpha0, eta=0.5, N_iter=N_iter, backtracking=True, c=1.0, showDetails=True)
	...
	invProb.plotSolAndLogPermeability(uOpt, obs=obs, save="uMAP_Gauss_kappa=" + str(kappa) + ".pdf", blocky=True)
