...
m2 = GeneralizedWavelet2d(rect, 1, 0.5, 5, p=1.1)
...
plt.figure();
plt.subplot(4, 1, 1)
plt.contourf(Fu.values, 20)
plt.subplot(4, 1, 2)
plt.contourf(Fu.values + Du_h.values, 20)
plt.subplot(4, 1, 3)
plt.contourf(Fu.values + Du_h.values + 0.5*D2u_h.values, 20)
plt.subplot(4, 1, 4)
plt.contourf(Fv.values, 20)
