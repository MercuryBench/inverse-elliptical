...
prior = GaussianFourier2d(rect, np.zeros((5,5)), 1.0, 1.0)
...
assert(invProb.I(uTruth, obs) == invProb.I_forOpt(uTruth.fouriermodes))
print(invProb.I(uTruth, obs))
print(invProb.Phi(uTruth, obs))


print(invProb.I_forOpt(uTruth.fouriermodes))
u0 = mor.mapOnRectangle(rect, "fourier", prior._mean)
