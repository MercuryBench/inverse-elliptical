...
obsposy = np.array([0.2, 0.3, 0.7, 0.1, 0.4, 0.8, 0.2, 0.8, 0.6, 0.9, 0.2, 0.6, 0.9, 0.6, 0.1])
...
f.append(mor.mapOnRectangle(rect, "handle", lambda x, y: ((x-1.2)**2 + (y-0.6)**2 < 0.05**2)*(-20.0)))
f.append(mor.mapOnRectangle(rect, "handle", lambda x, y: ((x-0.1)**2 + (y-0.9)**2 < 0.05**2)*(-20.0)))
f.append(mor.mapOnRectangle(rect, "handle", lambda x, y: ((x-1.0)**2 + (y-0.2)**2 < 0.05**2)*(-20.0)))
f.append(mor.mapOnRectangle(rect, "handle", lambda x, y: ((x-1.5)**2 + (y-0.6)**2 < 0.05**2)*(-20.0)))
f.append(mor.mapOnRectangle(rect, "handle", lambda x, y: ((x-1.3)**2 + (y-0.9)**2 < 0.05**2)*(-20.0)))
f.append(mor.mapOnRectangle(rect, "handle", lambda x, y: ((x-0.7)**2 + (y-0.6)**2 < 0.05**2)*(-20.0)))
f.append(mor.mapOnRectangle(rect, "handle", lambda x, y: ((x-0.1)**2 + (y-0.1)**2 < 0.05**2)*(-20.0)))
