...
m1 = GeneralizedGaussianWavelet2d(rect, 0.1, 2.5, 7) # 0.01, 1.5
...
#uTruth = m1.sample()
uTruthCoarse = mor.mapOnRectangle(rect, "handle", lambda x, y: myUTruth2(x, y))
uTruth = mor.mapOnRectangle(rect, "wavelet", parseResolution(uTruthCoarse.waveletcoeffs, rectCoarse.resol))
